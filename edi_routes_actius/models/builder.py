...
class ActiusEdiBuilder(object):

    def build_e1bpdlvpartner_element(self, parent_element, sequence='', role='', name='', gln='', route=''):
        ...
        ET.SubElement(element, "GLN_NO").text = gln
        ET.SubElement(element, "ROUTE_ID").text = 'R01 ' + route 
