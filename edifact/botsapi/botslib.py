...
#             LOGGER.warning('Error in sending error report: %(msg)s', {'msg': msg})
...
#             except Exception as msg:
#                 LOGGER.warning('Error sending email: %(msg)s', {'msg': msg})
...
def botsimport(*args):
    ...
    if modulepath in botsglobal.not_import:
        LOGGER.debug(_('No import of module "%(modulefile)s".'), {'modulefile': modulefile})
    ...
    try:
        ...
        LOGGER.debug(_('No import of module "%(modulefile)s": %(txt)s.'),
        ...
        LOGGER.debug(_('Error in import of module "%(modulefile)s": %(txt)s.'),
                                {'modulefile': modulefile, 'txt': msg})
...
def runscript(module, modulefile, functioninscript, **argv):
    ...
    '''
    LOGGER.debug('Run userscript "%(functioninscript)s" in "%(modulefile)s".',
